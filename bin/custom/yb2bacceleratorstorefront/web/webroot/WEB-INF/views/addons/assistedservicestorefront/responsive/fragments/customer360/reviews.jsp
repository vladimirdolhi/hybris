...
<div class="pageable-fragment asm-customer360-tab">
  ...
  <c:choose>
    <c:when test="${empty fragmentData.reviews}">
        <div class="clear">
            <spring:theme
	...
	<c:otherwise>
        ...
        <table id="asm-customer360-reviews-table" class="table techne-table">
            ...
            <tbody>
                <c:forEach items="${fragmentData.reviews}" var="reviewData">
                    ...
                    <tr>
                        ...
                        <td data-th="Date / Status" class="break-word"><span><fmt:formatDate value="${reviewData.created}" pattern="dd-MM-yyyy" />&nbsp;</span>/&nbsp;<spring:theme code="text.customer360.review.status.${reviewData.reviewStatus}" text="${reviewData.reviewStatus}"  htmlEscape="true"/> </td>
