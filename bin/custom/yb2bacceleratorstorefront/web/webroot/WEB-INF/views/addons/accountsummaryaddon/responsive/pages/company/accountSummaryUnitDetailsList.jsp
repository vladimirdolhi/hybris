...
<div class="row">
	<form:form id="filterByCriteriaForm" action="${accountSummaryUnitDetailsUrl}" method="get" class="clearfix account-summary-filter">
		...
		<div id="filterByKeyCriteria" class="filterByKey col-md-3 form-group" data-filter-by-key="${fn:escapeXml(filterByKey)}">
			<label for="filterByKey">
			...
			<div class="account-orderhistory">
                ...
                <div class="account-summary-table">
                    <table class="responsive-table">
                        <caption content="text.company.accountsummary.unit.details.page"></caption>
                        <tr class="responsive-table-head hidden-xs">
                            <th scope="col"><spring:theme code="text.company.accountsummary.documentNumber.label" /></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.documentType.label"/></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.date.label"/></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.dueDate.label"/></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.amount.label"/></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.openAmount.label"/></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.status.label"/></th>
                            <th scope="col"><spring:theme code="text.company.accountsummary.document.attachment.label"/></th>
                        </tr>
