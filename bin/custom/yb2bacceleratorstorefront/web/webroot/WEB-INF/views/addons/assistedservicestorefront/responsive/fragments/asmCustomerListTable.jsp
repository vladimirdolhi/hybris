                                        ...
                                        <td class="techne-table-xs-left-slot">
                                            <c:choose>
                                                <c:when test="${not empty customer.profilePicture}">
                                                    <a href="<c:out value='${emulateCustomerUrl}${ycommerce:encodeUrl(customer.uid)}'/>" class="responsive-table-link">
                                                ...
                                                <c:otherwise>
                                                    <a href="<c:out value='${emulateCustomerUrl}${ycommerce:encodeUrl(customer.uid)}'/>" class="responsive-table-link default-pic" title="<spring:theme code="text.asm.customerList.picture.alt"/>" alt="<spring:theme code="text.asm.customerList.picture.alt"/>" >
                                                    </a>
                                                </c:otherwise>
                                            </c:choose>
                                        </td>
